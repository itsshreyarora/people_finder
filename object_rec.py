from imageao.Detection import VideoObjectDetection
import os
import cv2
...
video_path = detector.detectObjectsFromVideo(camera_input=camera,
                        ...
                        , frames_per_second=20, log_progress=True, minimum_percentage_probability=40, detection_timeout=120, per_minute_function:forMinute)
